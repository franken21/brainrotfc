...
const MessiVsRonaldo = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-green-800 via-green-700 to-green-900 p-3 pb-16 relative overflow-hidden">
      ...
      <button
        onClick={() => navigate('/')}
        className="absolute top-3 left-3 z-30 px-3 py-2 bg-black/40 backdrop-blur rounded-lg text-white text-sm font-medium flex items-center gap-2 active:bg-black/60"
      >
        ← Tilbake
      </button>
